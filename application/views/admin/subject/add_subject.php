...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <div class="box body">
    <div class="container">
      <a class="btn btn-sm vcd-btn-primary btn-rd" style="margin-top:10px" href="<?php echo base_url($this->uri->segment(1))?>" role="button">
      ...
      <div class="form-group">
        <div class="row">
          ...
          <div class="col-md-6 col-sm-6 col-xs-9">
            <textarea class="form-control col-md-7 col-xs-12" rows="5" id="comment" name="description"></textarea>
