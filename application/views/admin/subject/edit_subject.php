    ...
    <div class="container">
      ...
      <div class="form-group">
        <div class="row">
          ...
          <div class="col-md-6 col-sm-6 col-xs-9">
            <input type="text" class="form-control col-md-7 col-xs-12" name="subject" value="<?php echo $result['subject']?>">
          </div>
      ...
      <div class="form-group">
        <div class="row">
          ...
          <div class="col-md-6 col-sm-6 col-xs-9">
            <textarea class="form-control col-md-7 col-xs-12" rows="5" id="comment" name="description"><?php echo $result['description']?></textarea>
