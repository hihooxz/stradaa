...
class Student extends CI_Controller {
	...
	function index(){
		$data['title_web']= 'Student Panel | Stradaa';
	...
	function view_schedule(){
		...
		$data['results'] = $this->mschedule->fetchScheduleStudent($this->session->userdata('idUser'));
	...
	function downloading(){
	        ...
	        $schedule = array('schedule'=>$this->mschedule->fetchScheduleStudent($id));
